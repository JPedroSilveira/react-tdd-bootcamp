...
const anySecret = 'secret'

export const defaultState: CombinedReducers = {
	success: false,
	guessedWords: [],
	secretWord: anySecret,
}

export const storeFactory = (
	initialState: CombinedReducers,
): Store<EmptyObject & CombinedReducers, AnyAction> => {
	return createStore(rootReducer, initialState, applyMiddleware(...middlewares))
}

export const findByTestAttribute = (
	wrapper: EnzymeShallowWrapper | EnzymeMountWrapper,
	val: string,
) => {
...
export type EnzymeShallowWrapper = ShallowWrapper<
	any,
	Readonly<{}>,
	React.Component<{}, {}, any>
>

export type EnzymeMountWrapper = ReactWrapper<
	any,
	Readonly<{}>,
	React.Component<{}, {}, any>
>
